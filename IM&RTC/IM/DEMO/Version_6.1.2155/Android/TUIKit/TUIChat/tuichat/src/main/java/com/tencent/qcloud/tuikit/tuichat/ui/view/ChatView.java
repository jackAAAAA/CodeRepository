...
//        这里是将InputView的UI发送消息的MessageHandler与业务ChatProvider.sendMessage发送消息的关联之处
        /**
         * 类跳转：
         * 1.{@link InputView#onClick}
         * 2.{@link com.tencent.qcloud.tuikit.tuichat.model.ChatProvider#sendMessage(TUIMessageBean, ChatInfo, IUIKitCallback)}
         */
