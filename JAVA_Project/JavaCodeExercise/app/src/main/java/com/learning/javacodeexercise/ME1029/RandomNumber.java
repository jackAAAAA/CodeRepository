package com.learning.javacodeexercise.ME1029;
...
public class RandomNumber {
    public static void main(String[] args) {
        ...
        for (int i = 0; i < 10; i++) {
            ...
            //num加rangeStart之后，值域是0到rangeEn-1
            num += rangeStart;
