...
//        画面旋转的代码_2
//        mTRTCCloud.setLocalViewMirror(TRTC_VIDEO_MIRROR_TYPE_DISABLE);
...
//            mTRTCCloud.stopLocalPreview();
            ...
            mTRTCCloud.setVideoMuteImage(decodeResource(getResources(), R.mipmap.live_subview_video_mute),5);
