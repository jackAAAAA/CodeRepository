package com.learning.javacodeexercise.ME1105;
...
public class GuessNumber {
    public static void main(String[] args) {
        ...
        while (!stopGame) {
            ...
            System.out.println("目标书已经生成，数字在" + rangeStart + "到" + rangeEnd + "之间，" +
            ...
            while (guessLeft > 0) {
                ...
                if (guessNum <= rangeStart || guessNum >= rangeEnd) {
                    System.out.println("请输入在" + rangeStart + "到" + rangeStart + "之间的数字，不包括这两个数字。");
                    continue;
                }
                //只要猜过一次，就算玩过了。
                if (gameStart) {
