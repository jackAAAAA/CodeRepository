package com.learning.javacodeexercise.ME1104;
        ...
        while (cont) {
            ...
            switch (optId) {
                ...
                case 3:
                    ...
                    System.out.println("所有年份最好成绩为第" + (bestYear + 1) + "年的" + names[bestScore] + "：成绩为" + scores[bestYear][bestScore] + "。" );
                    break;
                case 4:
                ...
                default:
                    cont = false;
                    System.out.println("不支持：" + optId + "，程序结束。");
            }
        }
    }
}
