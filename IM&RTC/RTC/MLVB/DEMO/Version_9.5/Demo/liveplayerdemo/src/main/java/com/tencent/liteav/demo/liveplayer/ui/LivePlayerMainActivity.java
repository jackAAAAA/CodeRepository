...
public class LivePlayerMainActivity extends Activity {
    ...
    private void startPlay() {
        ...
        if (code != Constants.PLAY_STATUS_SUCCESS) {
            ...
            mTRTCCloud.setListener(new TRTCCloudImplListener(LivePlayerMainActivity.this));
    ...
    private static class TRTCCloudImplListener extends TRTCCloudListener {

        private WeakReference<LivePlayerMainActivity> mContext;

        public TRTCCloudImplListener(LivePlayerMainActivity activity) {
            super();
        ...
        public void onFirstVideoFrame(String s, int i, int i1, int i2) {
            ...
            Log.i(TAG, "onFirstVideoFrame: Test");
