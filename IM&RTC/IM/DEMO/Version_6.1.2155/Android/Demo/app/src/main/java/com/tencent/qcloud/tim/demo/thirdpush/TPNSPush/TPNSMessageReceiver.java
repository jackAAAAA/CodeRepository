...
public class TPNSMessageReceiver extends XGPushBaseReceiver {
	 ...
	 * 2022年4月23日，暂时无法走到这个回调
	 */
	@Override
	public void onTextMessage(Context context, XGPushTextMessage message) {
//		从华为厂商通道的获取推送和透传消息
		DemoLog.d(LogTag, "透传消息：" + message.getCustomContent());
		DemoLog.d(LogTag, "消息内容：" + message.getContent());
	}
	...
	public void onNotificationClickedResult(Context context, XGPushClickedResult message) {
		...
		if (message.getActionType() == NotificationAction.clicked.getType()) {
			...
			text = "02OfflinePush_TPNSMessageReceiver" +  "通知被打开 :" + message;
			DemoLog.d(LogTag, text);
