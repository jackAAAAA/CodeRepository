...
public class CameraFboRender implements EglSurfaceView.Render, SurfaceTexture.OnFrameAvailableListener {
    ...
    private  int mWidth;
    private  int mHeight;
    private  VideoFrameReadListener videoFrameReadListener;

    public void setVideoFrameReadListener(VideoFrameReadListener videoFrameReadListener) {
        this.videoFrameReadListener = videoFrameReadListener;
    }
    ...
    @Override
    public void onDrawFrame(EGLContext eglContext) {
