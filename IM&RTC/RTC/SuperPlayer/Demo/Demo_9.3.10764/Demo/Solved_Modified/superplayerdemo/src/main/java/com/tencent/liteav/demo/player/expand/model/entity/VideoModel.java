...
public class VideoModel {
    ...
    public String toString() {
        return "parseVideoModel: " + "title: " + title +
                " videoURL: " + videoURL + " placeholderImage: " + placeholderImage +
                " duration: " + duration + " appid: " + appid + " fileid: " + fileid +
                " pSign: " + pSign + " multiVideoURLs: " + multiVideoURLs + " playDefaultIndex: " + playDefaultIndex;
    }
