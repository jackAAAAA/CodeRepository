...
public class MainActivity extends AppCompatActivity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    AppleArrayList<Apple> appleArrayList = new AppleArrayList<Apple>();
    ...
    List<Apple> fruits9 = new ArrayList<>();
    apple2.addMeToList(fruits9);

    Eater<Food> eater = new Eater<Food>() {
      @Override
    ...
    ReversableArrayList<Object> reversableArrayList = new ReversableArrayList<>();
