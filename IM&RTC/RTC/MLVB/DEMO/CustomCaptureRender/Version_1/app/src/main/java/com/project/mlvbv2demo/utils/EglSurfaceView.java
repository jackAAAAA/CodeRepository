...
public class EglSurfaceView extends SurfaceView implements SurfaceHolder.Callback {
    ...
    public void onStart() {
        if (mEGLThread != null) {
            mEGLThread.isStop = false;
        }
    }

    public void onStop() {
        if (mEGLThread != null) {
            mEGLThread.isStop = true;
        }
    }

    @Override
    public void surfaceChanged(SurfaceHolder holder, int format, int width, int height) {
        Log.e("SUMN", "screenW:" + width + ":" + "height:" + height);
        this.width = width;
        this.height = height;
...
//                        Log.e("lin","--------------------  " + (1000 / 60));
        ...
        private void onDraw() {
            ...
            mEGLSurfaceViewWeakRef.get().mRenderer.onDrawFrame(mEglHelper.getEglContext());
    ...
    public interface Render {
        ...
        void onDrawFrame(EGLContext eglContext);
