...
//                DemoLog.i(TAG, "onActivityCreated bundle totalUnreadCount: " + totalUnreadCount);

                DemoLog.i(TAG, "onActivityCreated bundle totalUnreadCount setHuaweiBadgeNum: " + totalUnreadCount);
                XGPushConfig.setHuaweiBadgeNum(getApplicationContext(), (int) totalUnreadCount);

//                DemoLog.i(TAG, "onActivityCreated bundle totalUnreadCount setBadgeNum: " + totalUnreadCount);
//                XGPushConfig.setBadgeNum(getApplicationContext(), (int) totalUnreadCount);

//                这行代码可以设置角标;DemoApplication.this：表示的是调用外部类的context
