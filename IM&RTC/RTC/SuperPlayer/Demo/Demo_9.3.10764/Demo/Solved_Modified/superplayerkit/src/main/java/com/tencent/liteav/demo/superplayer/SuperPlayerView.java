 ...
 * 超级播放器view
 * <p>
 * 具备播放器基本功能——视图显示 & 播放，此外还包括横竖屏切换、悬浮窗播放、画质切换、硬件加速、倍速播放、镜像播放、手势控制等功能，同时支持直播与点播
...
//
//    /**
//     * 真正的功能函数：点击直播/点播列表的item来播放视频 在 {@link SuperPlayerImpl}
//     * 跳转外部的某个类：{@link SuperPlayerImpl}
//     * 跳转外部的某个类的某个具体函数：{@link SuperPlayerImpl#onPlayEvent(int, Bundle)}
//     * 跳转到本类的某个具体函数：{@link #playWithModel(SuperPlayerModel)}
//     * @param model
//     */
//    public void playWithModel(final SuperPlayerModel model) {
//        if (model.videoId != null) { //通过appid、fileId、pSign来播放点播视频
