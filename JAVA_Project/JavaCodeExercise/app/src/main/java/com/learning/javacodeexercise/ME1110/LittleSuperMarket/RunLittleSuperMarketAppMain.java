package com.learning.javacodeexercise.ME1110.LittleSuperMarket;

import com.learning.javacodeexercise.ME1110.LittleSuperMarket.Person.Customer;
import com.learning.javacodeexercise.ME1110.LittleSuperMarket.supermarket.Merchandise;
import com.learning.javacodeexercise.ME1110.LittleSuperMarket.supermarket.StructureOfSupermarket;
        ...
        while (open) {
            ...
            if (customer.isDrivingCar) {
                if (structureOfSupermarket.parkingCount > 0) {
                    System.out.println("欢迎" + customer.name + "驾车而来。本店已经为您安排了车位，停车费免费哦。车位编号：" + structureOfSupermarket.parkingCount);
